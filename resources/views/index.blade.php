<x-layout :title="'Home'">
	<style>
		...
		.splash::after {
			...
			right: 0;
			height: 100px;
			background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgb(107, 114, 128) 100%);
		}
	...
	<section class="mb-10 w-full bg-gray-500">
		<!-- Splash Section -->
		...
		<div class="mb-10 px-6 py-10 md:px-12">
			...
			<ol class="list-decimal-bold mx-auto list-inside space-y-4 px-3 text-gray-800">
				@foreach ([
					...
					<li class="mx-auto flex items-start space-x-4 text-gray-100 rounded-lg bg-gray-400 md:bg-transparent px-4 py-6 md:py-2 shadow-lg">
						<ion-icon name="{{ $item['icon'] }}" class="text-3xl" size="large"></ion-icon>
						<div>
		...
		<section class="w-full bg-gray-500 py-4">
