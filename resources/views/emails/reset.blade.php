...
<body style="font-family: 'Inter', sans-serif; background-color: #f3f4f6; padding: 24px;">
	<div style="max-width: 400px; margin: 0 auto; background-color: #ffffff; padding: 18px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
		...
		<p style="color: #4a5568; margin-bottom: 24px;">We received a request to reset your password. You can reset your password by clicking the link below:</p>
